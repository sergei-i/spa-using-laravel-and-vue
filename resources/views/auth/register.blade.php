    ...
    <div class="bg-gray-300 mx-auto h-full flex justify-center items-center">
        <div class="w-96 p-6 rounded-lg bg-blue-900 shadow-xl">
            ...
            <form method="POST" action="{{ route('register') }}" class="pt-8">
                ...
                <div class="relative">
                    <label for="name" class="text-blue-500 text-xs font-bold pl-3 pt-2 absolute uppercase">Full
                        Name</label>
                ...
                <div class="relative pt-3">
                    <label for="email"
                           class="text-blue-500 text-xs font-bold pl-3 pt-2 absolute uppercase">E-Mail</label>
                ...
                <div class="relative pt-3">
                    <label for="password"
                           class="text-blue-500 text-xs font-bold pl-3 pt-2 absolute uppercase">Password</label>
                ...
                <div class="relative pt-3">
                    <label for="password-confirm" class="text-blue-500 text-xs font-bold pl-3 pt-2 absolute uppercase">Re-enter
                        Password</label>
